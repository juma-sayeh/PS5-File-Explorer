...
extern "C" bool bfpilot_unrar_stream_active(void);
extern "C" int bfpilot_unrar_stream_read(void *data, size_t size);
#endif
...
#ifdef FILE_USE_OPEN
#ifdef BFPILOT_UNRAR_STREAM
      if (HandleType==FILE_HANDLESTD && bfpilot_unrar_stream_active())
        Success=true;
      else
#endif
...
#endif
#ifdef BFPILOT_UNRAR_STREAM
    if (bfpilot_unrar_stream_active())
      return bfpilot_unrar_stream_read(Data,Size);
#endif
  }
#ifdef _WIN_ALL

/*
 * File Explorer - runtime diagnostics and append logging.
 */
...
#define BFPILOT_LOG_PATH "/data/FileExplorer/log.txt"
#define BFPILOT_CRASH_LOG_PATH "/data/FileExplorer/crash.log"
...
bfpilot_diag_can_write_data_bfpilot(void) {
  ensure_diag_dir();
  return probe_write_file(BFPILOT_DATA_DIR "/.file_explorer_write_probe");
}
